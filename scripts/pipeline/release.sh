...
zip -r $local_path . -x "*.git/" -x ".git/**" -x "*.github/" -x ".github/**" -x "*.idea/" -x ".idea/**" -x "*.vscode/" -x ".vscode/**" -x "*types/" -x "types/**" -x "*test/" -x "test/**" -x "*.eslintrc.js" -x ".eslintrc.js" -x "*node_modules/" -x "node_modules/**" -x "*.prettierrc" -x ".prettierrc" -x "*nest-cli.json" -x "nest-cli.json" -x "*README.md" -x "README.md" -x "*tsconfig.build.json" -x "tsconfig.build.json" -x "*tsconfig.json" -x "tsconfig.json" -x "*yarn.lock" -x "yarn.lock" -x "*.gitignore" -x ".gitignore" -x "*scripts/" -x "scripts/**"
